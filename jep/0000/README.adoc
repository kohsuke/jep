...
* https://github.com/jenkinsci/credentials-plugin/compare/master...amuniz:data-api[credentials PoC]
* https://github.com/jenkinsci/ssh-credentials-plugin/compare/master...amuniz:data-api[ssh-credentials PoC]
